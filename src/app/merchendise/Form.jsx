...
export default function Form(props)
{
    return <form id="formData" onSubmit={props.handleSubmit}>
        ...
        <div className="formComponents" id="submitForm">
            <button className="formButtons" style={{backgroundColor : "orangered"}} type="submit">Submit</button>
            <button className="formButtons" onClick={props.handleClick}>Close</button>
        </div>
    </form>
}