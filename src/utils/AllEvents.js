const events = [
...

    {
        ...
        eventName: 'H42',
        eventDate: {
            prelims: ['April 18, 2023'],
            finals: 'April 20, 2023',
        },
        eventPoster: '/assets/events/poster/H42.jpeg',
        eventType: 'coding',
        eventHashtags: ['cp', 'fun'],
        eventCoordinators: [
            'Ayush  [ 8540062753 ]',
            'Arindam [ 9103158993 ]',
            'Dibyo [ 7294925744 ]',
        ...
        minMembers: 3,
        maxMembers: 5,
        eventDescription: ['H42 Is an cp event'],
        eventRules: ['Enjoyable event'],
    },
]
