...
const Countdown = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 md:px-8">
    <div className="grid grid-rows-1 gap-4 md:grid-cols-4 lg:gap-8">
      <div className="flex flex-col items-center justify-center rounded-lg bg-[#6100FF] p-4 lg:p-8">
        ...
        <div className="text-sm font-semibold text-gray-100 sm:text-base">Days</div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center rounded-lg bg-[#6100FF] p-4 md:p-8">
        ...
        <div className="text-sm font-semibold text-gray-100 sm:text-base">Hours</div>
      </div>

      <div className="flex flex-col items-center justify-center rounded-lg bg-[#6100FF] p-4 md:p-8">
        <div className="text-xl font-bold text-gray-100 sm:text-2xl md:text-3xl">{minutes}</div>
        <div className="text-sm font-semibold text-gray-100 sm:text-base">Minutes</div>
      </div>

      <div className="flex flex-col items-center justify-center rounded-lg bg-[#6100FF] p-4 md:p-8">
        <div className="text-xl font-bold text-gray-100 sm:text-2xl md:text-3xl">{seconds}</div>
        <div className="text-sm font-semibold text-gray-100 sm:text-base">Seconds</div>
      </div>
    </div>
   </div>
  </div>
