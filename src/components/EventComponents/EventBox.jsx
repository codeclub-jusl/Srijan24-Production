...
const EventBox = ({ children, imgSrc, ...props }) => {
    return (
        <div
            {...props}
            className='relative max-w-xs overflow-hidden rounded-2xl shadow-lg group eventBoxAri'
        >
            <img
                src={imgSrc}
                alt=''
                className='w-full h-auto transition-opacity duration-500 group-hover:opacity-75 eventBoxImage'
            />
