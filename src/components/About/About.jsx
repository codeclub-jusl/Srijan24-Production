    ...
    return (
        <section className='about'>
            <div className='about_content w-full h-fit bg-transparent relative -z-0 text-white flex flex-col justify-center gap-12'>
                ...
                &emsp;Founding members of National Council of Bengal, the parent body of the Jadavpur University, in 1906 set the goal "To achieve self reliance through empowerment of Youth by imparting Best of Global Knowledge" and the varisty yet today continues to do the same
                ...
                <p className='relative font-normal text-lg sm:text-xl text-justify aboutText'>
                &emsp;In the heart of Kolkata, where passion ignites, <b className='yellowColor'>Srijan</b> flourishes — an annual tribute to creativity and excellence, cradled by Jadavpur. From its inception in 2007 as a humble spark, it has flourished into an spectacular festival of technology and management.<br/>

                &emsp;With each passing year Srijan paints the canvas of curiosity with vibrant strokes. From the intricate patterns of coding to the strategic symphony of management, it beckons minds to explore their dreams in innovation, design and robotics.
                ...
                &emsp;In this four-day spectacle, Srijan transcends from being merely a festival, it becomes a chorus of the most brilliant minds, echoing through the halls of Jadavpur's heritage.
