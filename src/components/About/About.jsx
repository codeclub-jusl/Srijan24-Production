    ...
    return (
        <section className='about'>
            <div className='about_content w-full h-fit bg-transparent relative -z-0 text-white flex flex-col justify-center gap-12'>
                ...
                <p className='queryText'>For inquiries, please feel free to contact us via email at <a href='mailto:srijan.ju@jadavpuruniversity.in' className='queryMail'>srijan.ju@jadavpuruniversity.in</a> or <a href='mailto:srijan24.jadavpuruniversity@gmail.com' className='queryMail'>srijan24.jadavpuruniversity@gmail.com</a>, or contact us by phone at <a href='tel:7080623712' className='queryMail'>7080623712</a> or <a href='tel:7439377598' className='queryMail'>7439377598</a>. We are here to assist you with any questions or concerns you may have.</p>
            </div>
        </section>
    )
}
